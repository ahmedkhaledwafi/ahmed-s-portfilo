            ...
            <section className="about-me--skills">
                ...
                <div className="about-me--skills-container">
                    <div className="skills-text">
                        <ul>
                            <li ref={element => { skillsText.current[0] = element; }}>
                                Web apps responsive to all screen sizes.
                            </li>
                            <li ref={element => { skillsText.current[1] = element; }}>
                                Proficient understanding of web markup, including HTML5, CSS3.
                            </li>
                            <li ref={element => { skillsText.current[2] = element; }}>
